namespace Framework.ComponentModel
{
        ...
        where T : EditableObject<T>, new()
    {
        ...
        private readonly Subject<object> beginEditingSubject;
        private readonly Subject<object> cancelEditingSubject;
        private readonly Subject<object> endEditingSubject;
        ...
        {
            this.beginEditingSubject = new Subject<object>();
            this.cancelEditingSubject = new Subject<object>();
            this.endEditingSubject = new Subject<object>();
        } 
        ...
        /// </value>
        public IObservable<object> WhenBeginEditing
        {
        ...
        /// </value>
        public IObservable<object> WhenCancelEditing
        {
        ...
        /// </value>
        public IObservable<object> WhenEndEditing
        {
        ...
        {
            this.beginEditingSubject.OnNext(null);
        }
        ...
        {
            this.cancelEditingSubject.OnNext(null);
        }
        ...
        {
            this.endEditingSubject.OnNext(null);
        }
